    ...
    if (!$error) {
        ...
        if (!empty($_FILES["imagen"]["name"])) {
            ...
            if (!in_array($file_type, $allowed_types)) {
                ...
                if (!empty($proveedor["imagen"]) && file_exists($imagen_dir . "/" . $proveedor["imagen"])) {
                    unlink($imagen_dir . "/" . $proveedor["imagen"]);
                }
        ...
        if (!$error) {
            try {
                $sql = "UPDATE proveedores SET nombre=:nombre, empresa=:empresa, email=:email, telefono=:telefono, direccion=:direccion, imagen=:imagen WHERE id=:id";
                $stmt = $conn->prepare($sql);
        ...
        <div class="col-md-7">
            ...
            <div class="card shadow">
                <div class="card-header bg-success text-white">
                    <h4 class="mb-0">✏️ Editar Proveedor</h4>
                </div>

                <div class="card-body">

                    <?php if (!$error && $proveedor): ?>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nombre" name="nombre" 
                                   value="<?= htmlspecialchars($proveedor['nombre'], ENT_QUOTES, 'UTF-8') ?>" 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="empresa" name="empresa" 
                                   value="<?= htmlspecialchars($proveedor['empresa'], ENT_QUOTES, 'UTF-8') ?>" 
                                   required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="email" name="email" 
                                   value="<?= htmlspecialchars($proveedor['email'], ENT_QUOTES, 'UTF-8') ?>" 
                                   required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="telefono" name="telefono" 
                                   value="<?= htmlspecialchars($proveedor['telefono'], ENT_QUOTES, 'UTF-8') ?>" 
                                   required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="direccion" name="direccion" 
                                   value="<?= htmlspecialchars($proveedor['direccion'], ENT_QUOTES, 'UTF-8') ?>" 
                                   required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <?php if (!empty($proveedor['imagen'])): ?>
                                    <img src="<?= htmlspecialchars($url_base . 'modules/proveedores/imagen/' . $proveedor['imagen'], ENT_QUOTES, 'UTF-8') ?>" 
                                         width="120" class="rounded shadow-sm mb-3" alt="Imagen proveedor"
                    ...
                    <?php else: ?>
                        ...
                        <a href="readproveedor.php" class="btn btn-secondary">← Volver</a>
                    <?php endif; ?>
